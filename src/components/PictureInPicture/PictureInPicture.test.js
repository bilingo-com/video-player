...
import Fullscreen from './PictureInPicture';
...
describe('Fullscreen', () => {
  ...
  beforeAll(() => {
    component = shallow(<Fullscreen ariaLabel="Fullscreen" />);
  });
  ...
  it('has correct aria-label', () => {
    expect(component.find('button').prop('aria-label')).toEqual('Fullscreen');
  });
});
